    ...
    {  
      ...
      else
      {
        ...
        else if (command.containsKey(F("PSICalib")))
        {
          ...
          //   //Store the new coefficients in eeprom
            // saveParam("PSICalibCoeffs0",storage.PSICalibCoeffs0);//-22.636
            // saveParam("PSICalibCoeffs1",storage.PSICalibCoeffs1);//104.8007 
            saveParam("PSICalibCoeffs0",-22.636);//-22.636
            saveParam("PSICalibCoeffs1",104.8007);//104.8007          
            PublishSettings();
